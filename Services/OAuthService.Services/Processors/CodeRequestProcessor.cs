...
namespace OAuthService.Services.Processors
{
    public class CodeRequestProcessor : BaseRequestProcessor, IRequestProcessor<ICodeGrantTokenRequest>
    {
        ...
        public async Task<AccessTokenResponse> ProcessToResponseAsync(Client responseAud, ICodeGrantTokenRequest request, CancellationToken cancellationToken = default)
        {
